...
/* harmony import */ var _modules_validate_validateForms__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/validate/validateForms */ "./js/modules/validate/validateForms.js");
/* harmony import */ var _modules_yandex_map__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/yandex-map */ "./js/modules/yandex-map.js");
/* harmony import */ var _modules_videoController__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/videoController */ "./js/modules/videoController.js");
/* harmony import */ var _modules_input_file__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/input-file */ "./js/modules/input-file.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_1__["accordion"])();
    Object(_modules_menu__WEBPACK_IMPORTED_MODULE_2__["menu"])();
    Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["takeControlTabs"])();
    Object(_modules_phone_mask__WEBPACK_IMPORTED_MODULE_5__["phoneMask"])();
    Object(_modules_input_file__WEBPACK_IMPORTED_MODULE_9__["inputFile"])();
    Object(_modules_validate_validateForms__WEBPACK_IMPORTED_MODULE_6__["validateForms"])();
    Object(_modules_swiper__WEBPACK_IMPORTED_MODULE_4__["swiper"])();
    Object(_modules_videoController__WEBPACK_IMPORTED_MODULE_8__["videoController"])();
    Object(_modules_yandex_map__WEBPACK_IMPORTED_MODULE_7__["yandexMap"])();
    Object(_modules_cookie__WEBPACK_IMPORTED_MODULE_10__["cookie"])();
  });
});
...
var accordion = function accordion() {
  ...
  if (accordions[0]) {
    var removeActiveClass = function removeActiveClass(accordionItems) {
    ...
    accordions.forEach(function (accordion) {
      ...
      accordionItems.forEach(function (accordionItem) {
        var accordionButton = accordionItem.querySelector('[data-accordion-button]');
...
var cookie = function cookie() {
  var cookieElement = document.querySelector('[data-cookie-element]');
  if (cookieElement) {
    var _cookie = localStorage.getItem('cookie');
    if (_cookie === 'accepted') {
      cookieElement.remove();
      return;
    }
    cookieElement.classList.add('active');
    var cookieAcceptButton = cookieElement.querySelector('[data-cookie-accept]');
...
var menu = function menu() {
  ...
  var burgerBtn = document.querySelector('[data-menu-burger]');
  var closeIcon = document.querySelector('[data-menu-close]');
...
var modals = function modals() {
  ...
  if (modalButtons[0] && modals[0]) {
    var initModal = function initModal(openModalbutton) {
      var modalName = openModalbutton.getAttribute('data-modal-button');
      var modal = modals.find(function (modal) {
        return modal.getAttribute('data-modal') === modalName;
      });
      var openModal = function openModal(modalWindow) {
        body.style.overflow = 'hidden';
        body.style['padding-right'] = scrollbarWidth;
    ...
    var handleCloseButtonClick = function handleCloseButtonClick(evt) {
      var closeButton = evt.target.closest('[data-close-modal]');
      if (closeButton) {
        var modal = closeButton.closest('[data-modal]');
        modal.classList.remove('active');
        restoreScroll();
      }
    };
    var handleEscPress = function handleEscPress(evt) {
      if (evt.key === 'Escape') {
...
var phoneMask = function phoneMask() {
  [].forEach.call(document.querySelectorAll('[data-tel-mask]'), function (input) {
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Autoplay"], swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Navigation"], swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Pagination"], swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Controller"], swiper_modules__WEBPACK_IMPORTED_MODULE_1__["EffectFade"]]);
var swiper = function swiper() {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-main', {
    loop: true,
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-companies', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Autoplay"], swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Pagination"]],
    loop: true,
    slidesOffsetAfter: 0,
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-certificates', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Autoplay"], swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Pagination"]],
    loop: true,
    slidesPerView: 1.2,
    spaceBetween: 5,
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-images', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Autoplay"], swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Pagination"]],
    loop: true,
    slidesPerView: 1,
    autoplay: {
  ...
  var swiperDocuments = document.querySelector('.swiper-documents');
  var swiperDocumentsSlides = document.querySelectorAll('.documents__slide');
  var checkSlidesWidth = function checkSlidesWidth() {
    if (!swiperDocuments) return;
    var SLIDE_WIDTH = 225;
    var slidesCount = swiperDocumentsSlides.length;
    var allSlidesWidth = SLIDE_WIDTH * slidesCount;
    var sliderContainerWidth = swiperDocuments.closest('.accordion_hidden-wrap').offsetWidth;
    return allSlidesWidth > sliderContainerWidth;
  };
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swiperDocuments, {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Autoplay"], swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Pagination"]],
    slidesPerView: 'auto',
    loop: false,
    spaceBetween: 5,
  ...
  var swiperMap = null;
  var initSwiperRegion = function initSwiperRegion() {
    var slider = document.querySelector('.swiper-region');
    if (slider && !slider.getAttribute('inited')) {
      swiperMap = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](slider, {
        modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Autoplay"], swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Pagination"]],
        loop: true,
        slidesPerView: 1,
  ...
  initSwiperRegion();
  var map = document.querySelector('.region__map');
  if (map) {
    var main = document.querySelector('main');
    main.addEventListener('click', function (evt) {
      if (evt.target.classList.contains('region__point')) {
        initSwiperRegion();
        var mapPoint = evt.target;
  ...
  var swiperCompletedWork = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-completed-work', {
  ...
  var swiperCompletedWorkImg = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-completed-work-img', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Autoplay"], swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Navigation"]],
    loop: true,
    slidesPerView: 1
  });
  ...
  var swipePhotoList = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-photo-list', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Autoplay"], swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Pagination"], swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Navigation"], swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Grid"]],
    loop: true,
    slidesPerView: 2,
    spaceBetween: 10,
    allowTouchMove: false,
  ...
  var swiperTest = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-full-info', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Autoplay"], swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Pagination"], swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Navigation"], swiper_modules__WEBPACK_IMPORTED_MODULE_1__["Controller"]],
    loop: true,
    slidesPerView: 1,
    spaceBetween: 10,
    watchSlidesProgress: true,
...
/*!****************************!*\
  !*** ./js/modules/tabs.js ***!
  \****************************/
/*! exports provided: takeControlTabs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "takeControlTabs", function() { return takeControlTabs; });
...
/***/ "./js/modules/validate/validateForms.js":
/*!**********************************************!*\
  !*** ./js/modules/validate/validateForms.js ***!
  \**********************************************/
/*! exports provided: validateForms */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "validateForms", function() { return validateForms; });
/* harmony import */ var _validator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validator */ "./js/modules/validate/validator.js");
/* harmony import */ var _validatorConfig__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./validatorConfig */ "./js/modules/validate/validatorConfig.js");
...
var validateForms = function validateForms() {
  var validate = function validate(form) {
    var inputContainers = form.querySelectorAll('[data-input-wrap]');
    inputContainers.forEach(function (inputContainer) {
      var input = inputContainer.querySelector('[data-name]');
      if (!input) return;
    ...
    var validationErrors = Object(_validator__WEBPACK_IMPORTED_MODULE_0__["validator"])(formData, _validatorConfig__WEBPACK_IMPORTED_MODULE_1__["validatorConfig"]);
    var errorsArray = Object.keys(validationErrors);
    if (errorsArray.length) {
      errorsArray.forEach(function (errorFieldName) {
        var inputWithError = form.querySelector("[data-name=\"".concat(errorFieldName, "\"]"));
        var inputWithErrorContainer = inputWithError.closest('[data-input-wrap]');
        var errorField = inputWithErrorContainer.querySelector('[data-input-error]');
        if (errorField) {
  ...
  // все формы
  var addEventListenersForms = function addEventListenersForms() {
    var enrolleToCourseForm = document.querySelectorAll('[data-form]');
    if (enrolleToCourseForm.length) {
      enrolleToCourseForm.forEach(function (form) {
        if (!form.getAttribute('validationiinited')) {
          form.setAttribute('validationiinited', 'true');
          Object(_phone_mask__WEBPACK_IMPORTED_MODULE_2__["phoneMask"])();
          var submitButton = form.querySelector('[data-form-submit-button]');
          var hiddenSubmitButton = form.querySelector('[data-hidden-submit-button]');
          ...
          form.addEventListener('submit', function () {
            var currentModal = form.closest('[data-modal]');
            if (currentModal) {
              currentModal.classList.remove('active');
            }
            var successModal = document.querySelector('[data-modal="notification"]');
            if (successModal) {
...
/***/ "./js/modules/validate/validator.js":
/*!******************************************!*\
  !*** ./js/modules/validate/validator.js ***!
  \******************************************/
...
var validator = function validator(fieldData, validationConfig) {
  var EMAIL_REGEX = /^([A-Za-z0-9_\-]+(?:\.[A-Za-z0-9_\-]+)*@)?([A-Za-z0-9_\-]+(?:\.[A-Za-z0-9_\-]+)*)\.([A-Za-z]{2,4})$/;
  var errors = {};
  var validate = function validate(validateMethod, validationData, config) {
  ...
  for (var fieldName in fieldData) {
    for (var validateMethod in validationConfig[fieldName]) {
      var error = validate(validateMethod, fieldData[fieldName], validationConfig[fieldName][validateMethod]);
      if (error) {
...
/***/ "./js/modules/validate/validatorConfig.js":
/*!************************************************!*\
  !*** ./js/modules/validate/validatorConfig.js ***!
  \************************************************/
/*! exports provided: validatorConfig */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "validatorConfig", function() { return validatorConfig; });
var validatorConfig = {
  name: {
    isRequired: {
...
/*!***************************************!*\
  !*** ./js/modules/videoController.js ***!
  \***************************************/
/*! exports provided: videoController */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var videoController = function videoController() {
  ...
  var playBtn = document.querySelector('.video-block__play');
...
var yandexMap = function yandexMap() {
  if (document.getElementById('yandex-map') !== null) {
    var init = function init() {
      ...
      var placemark = new ymaps.Placemark([54.780153, 56.072265], {}, {
